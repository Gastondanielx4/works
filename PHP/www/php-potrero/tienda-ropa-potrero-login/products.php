                ...
                <div class="product_main">
                    <?php
                            ...
                            while ($reg = mysqli_fetch_array($datos)) {?>
                                <div class="project_box " style="background-color: white; padding-bottom:0.5rem">
                                    <div class="dark_white_bg"><img src="data:image/jpg;base64, <?php echo base64_encode($reg['imagen'])?>" alt=""
                                    height="300px" )/></div>
                                    <h4 class="card-title" style="width: 100%; font-size:20px;"><?php echo ucwords($reg['tipo_de_prenda']) ?>
                                    <?php echo ucwords($reg['marca']) ?>
                                    </h4>
                                    <a href="<?php echo ucwords($reg['link_pago']) ?>" class="btn btn-primary">Buy : <span style="font-weight:bold; font-size:14px;">$
                                        <?php echo $reg['precio']; ?>
                                    </span></a>
                                    <br/>
                                    <a style="font-weight:bold; font-size:14px;color: blue; margin:1rem" href="product.php?id=<?php echo $reg['id'];?>" >Ver Producto
                                    </a>
                                </div>
                            <?php } ?>
